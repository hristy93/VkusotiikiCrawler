...
namespace VkusotiikiCrawler
{
    public class Recipe
    {
        ...
        "джалеби", "бразил", "тирамису", "америка", "кренвирш", "паеля", "рьощ", "тортийа", "тортия", "плескавиц", "прошуто", "еспресо",
        "нахут", "фетучини", "капрезе", "азиатски", "кростата", "ашуре", "бешамел", "майонез", "гарнитура", "шотландск", "пармиджиана",
        "тортелин", "ньоки", "кускус", "френск", "кимбаб", "кошничк", "панакота", "бюрек", "чили кон карне", "буркан", "джелато" };
